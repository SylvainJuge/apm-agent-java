...
public class ConstructorAdvice {
    ...
    public static void onExit(@Advice.This RestChannel restChannel,
                              @Advice.Argument(0) HttpChannel httpChannel) {

        helper.registerRestChannel(httpChannel, restChannel);
    }
}
