...
public class ReleaseAndCopyAdvice {

    private static final ElasticsearchHelper helper = ElasticsearchHelper.getInstance();

    @Advice.OnMethodExit(suppress = Throwable.class, onThrowable = Throwable.class, inline = false)
    public static void onExit(@Advice.This HttpRequest request,
                              @Advice.Return @Nullable HttpRequest requestCopy) {

        helper.httpRequestRelease(request, requestCopy);
    }
}
